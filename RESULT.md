# hypertension.md — Build Complete ✅

**Domain:** hypertension.md  
**Topic:** High blood pressure management, lifestyle, medications  
...
1. **GitHub Repository**
   ```bash
   gh repo create loki-mamv/hypertension-md --public
   gh api repos/loki-mamv/hypertension-md/collaborators/mike32snake -X PUT -f permission=admin
   ```
...
3. **Configure DNS**
   ...
   - Point hypertension.md to loki-mamv.github.io
...
**Output Location:** `/Users/loki/assistant/output/md-sites/remaining/hypertension/`  
